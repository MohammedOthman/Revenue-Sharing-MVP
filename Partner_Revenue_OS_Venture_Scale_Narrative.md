...
> **Phase discipline (governing):** This narrative conforms to the canonical roadmap **Phase 1 Capture (PRM) → Phase 2 Settle → Phase 3 Orchestrate** (see `ROADMAP_ALIGNMENT_AUDIT.md` §2). Its venture-stage language maps as: Wedge + Repeatable Product = Phase 1 Capture; Platform Expansion = Phase 2 Settle; Category Ownership → Outcome = Phase 3 Orchestrate. The entry product is sold and experienced as an easy, claim-centric **PRM** — never a fintech in Phase 1; no money movement before the Phase-2 settlement gate.
...
6. **Ecosystem revenue is now large and high-quality.** The defensible figure: **50% of organizations attribute 26%+ of their revenue to partners** (HubSpot × Canalys × Partnership Leaders, *State of Partner Ops and Programs* 2022, n=664), and Forrester's 2025 partner-ecosystem research found **~67%** of B2B orgs expect indirect/partner revenue to grow strongly year-over-year. This is the demand-side proof that the revenue being governed is real and growing. **[External — HubSpot/Canalys/Partnership Leaders; Forrester]** *(A previously cited "~24% median / top-quartile >40%" figure was removed: it could not be traced to a real named survey.)*
...
8. **The regional accelerant (added for a GCC-anchored case).** Saudi Arabia's digital economy was **already ~SAR 495B (~$131.9B) in 2024** (MCIT / Vision 2030 Annual Report, ~15% of GDP; GASTAT separately reports it at **16.0% of GDP in 2024** — attribute the two figures separately, they are different instruments), with a national FinTech strategy and a deliberate push to build B2B, partnership-driven private-sector growth under **Vision 2030**. For addressable-spend anchoring, use **IDC's ~$39.6B KSA ICT spend (2025)**; the digital-economy figure is macro context only. A Gulf-anchored beachhead rides a state-sponsored wave of exactly the partner-led B2B activity this product governs. **[External — MCIT/Vision 2030; GASTAT; IDC]; [Assumption]** that this is the right wedge. *(The earlier "~$87B by 2025 → ~$133B by 2030" framing was retired: 2024 actuals already exceeded it.)*
...
As B2B revenue becomes recurring, multi-touch, partner- and marketplace-intermediated, and audited, the spreadsheets and first-touch CRM credit companies use to run partner revenue are structurally breaking — half of organizations already attribute 26%+ of their revenue to partners (HubSpot × Canalys × Partnership Leaders, 2022, n=664), yet much of it is silently misattributed. Partner Revenue OS governs one canonical object, the Partner Revenue Claim, to give the Head of Partnerships defensible evidence and the CFO an audit-grade record of what partners drove and what is owed. It lands compliance-native in the GCC (ZATCA, multi-entity, Sharia-compliant revenue share — a wedge incumbents underserve) and expands into global co-sell/marketplace ecosystems and the Partner P&L. Pre-revenue and pre-seed, it is raising a milestone-based validation round to ship the MVP, sign 3–5 paid design partners, and produce the first finance-grade proof — building toward an identity-resolution data and finance-trust moat.
...
| **"The first market is too small."** | Beachhead-to-TAM doubt. | The GCC wedge is a *beachhead*, not the TAM. The same claim ledger expands **horizontally across every industry and geography where B2B entities share revenue** — of which global co-sell/marketplace ecosystems ($30B→$163B marketplace migration) are the single largest example, not the boundary — plus the Partner P&L, sized off partner-attributed revenue, not the PRM tool market. | A locked beachhead decision + a credible, evidenced expansion path. |
...
- **Best "why now":** B2B revenue is becoming recurring (usage pricing), multi-touch (AI + marketplaces, ~$30B→~$163B marketplace migration), partner-intermediated (partner-tool adoption 86%→94% in a year; 50% of orgs attribute 26%+ of revenue to partners — HubSpot × Canalys 2022), and *audited* (ZATCA, IFRS 15) — all at once. Spreadsheets and first-touch CRM credit cannot survive that, and compliance demand for governing partner revenue does not get cut in a downturn.
...
- HubSpot × Canalys × Partnership Leaders, *State of Partner Ops and Programs* 2022 (n=664) — 50% of organizations attribute 26%+ of revenue to partners: [hubspot.com](https://www.hubspot.com/company-news/the-state-of-partner-ops-and-programs-report-2022). Forrester, *State of Partner Ecosystems* 2025 — ~67% expect strong YoY indirect/partner revenue growth: [forrester.com](https://www.forrester.com/blogs/the-state-of-partner-ecosystems-2025/). *(The previously cited Crossbeam "~24% median / >40% top-quartile" figure was removed as untraceable to a real named survey; Crossbeam deal-performance stats may be used as color only, never as the business case.)*
...
- Saudi digital economy actuals — ~SAR 495B (~$131.9B) in 2024, ~15% of GDP (MCIT / Vision 2030 Annual Report): [mcit.gov.sa](https://www.mcit.gov.sa/en); 16.0% of GDP in 2024 (GASTAT): [stats.gov.sa](https://www.stats.gov.sa/en/w/news/150); IDC KSA ICT spend ~$39.6B (2025) as the addressable-spend anchor. *(The earlier "~$87B by 2025 → ~$133B by 2030" target framing was retired — 2024 actuals already exceeded it.)* FinTech strategy and Vision 2030 context: [vision2030.gov.sa](https://www.vision2030.gov.sa/en), [trade.gov — Saudi Arabia Digital Economy](https://www.trade.gov/country-commercial-guides/saudi-arabia-digital-economy-0).
