...
6. **Ecosystem revenue is now large and high-quality.** The HubSpot × Canalys × Partnership Leaders survey (2022, n=664) found **50% of organizations attribute 26%+ of their revenue to partners**, while **40% have no dedicated partner-ops headcount** — the clearest under-tooled signal — and partner-influenced deals are widely reported to show **higher win rates, larger order values, and faster cycles** than direct. This is the demand-side proof that the revenue being governed is real and growing. **[External — HubSpot × Canalys × Partnership Leaders, *State of Partner Ops and Programs* 2022]**
...
8. **The regional accelerant (added for a GCC-anchored case).** Saudi Arabia's digital economy already reached **~SAR 495B (~$132B) in 2024** (MCIT/Vision 2030 Annual Report, ~15% of GDP; GASTAT separately reports 16.0% of GDP), with ICT spend of **~$39.6B (IDC, 2025)** as the addressable-spend anchor, a national FinTech strategy, AI spend growing ~40% CAGR, and a deliberate push to build B2B, partnership-driven private-sector growth under **Vision 2030**. A Gulf-anchored beachhead rides a state-sponsored wave of exactly the partner-led B2B activity this product governs. **[External — MCIT/Vision 2030, GASTAT, IDC]; [Assumption]** that this is the right wedge.
...
- **CRM (Salesforce/HubSpot/Dynamics).** It is the system of record for opportunities, but it reads the *gross/booking amount* and lacks clean partner fields — so it computes the wrong base for marketplace private offers and silently misclassifies partner-sourced deals as direct. Third-party vendors call this **"Partner Attribution Leak"** — partner-sourced deals silently recorded as direct revenue when PRM↔CRM mapping fails. The *mechanism* is real and compounds over time, but no credible quantification exists; audit the magnitude internally rather than citing a percentage. **[External — Magentrix (trademarked term, unquantified); Confirmed thesis on the mechanism]**
...
The internal strategy describes a clean **Land → Expand → Own** sequence and an MVP→V1→V2→V3 build path. Mapped to venture stages below. (Canonical phases per `README.md`: Stages 1–2 = Phase 1 PRM/Capture; Stage 3 = Phase 2 Settle; Stages 4–5 = Phase 3 Orchestrate. No money movement before Phase 3.)
...
- **Best "why now":** B2B revenue is becoming recurring (usage pricing), multi-touch (AI + marketplaces, ~$30B→~$163B marketplace migration), partner-intermediated (partner-tool adoption 86%→94% in a year; 50% of orgs attribute 26%+ of revenue to partners), and *audited* (ZATCA, IFRS 15) — all at once. Spreadsheets and first-touch CRM credit cannot survive that, and compliance demand for governing partner revenue does not get cut in a downturn.
...
- HubSpot × Canalys × Partnership Leaders, *State of Partner Ops and Programs 2022* (n=664) — 50% of organizations attribute 26%+ of revenue to partners; 40% have no partner-ops FTE: [hubspot.com](https://www.hubspot.com/company-news/the-state-of-partner-ops-and-programs-report-2022). *(Replaces an earlier "~24% median partner-sourced revenue" figure that could not be traced to a named survey — see the Master Strategy Dossier, Appendix B.)* Partner-deal performance deltas (win-rate, order-value, cycle-time): directional vendor research, e.g. [crossbeam.com](https://www.crossbeam.com/what-is-ecosystem-led-growth).
...
- Saudi Arabia digital economy — ~SAR 495B (~$132B) in 2024, ~15% of GDP (MCIT/Vision 2030 Annual Report); 16.0% of GDP (GASTAT); ICT spend ~$39.6B (IDC, 2025): [mcit.gov.sa](https://www.mcit.gov.sa/), [stats.gov.sa](https://www.stats.gov.sa/), [vision2030.gov.sa](https://www.vision2030.gov.sa/en). *(Replaces the stale "~$87B by 2025 → ~$133B by 2030" forecast — 2024 actuals already exceeded it; see the Master Strategy Dossier, Part VI.)*
