...
| **Narrative & finance model** | `Partner_Revenue_OS_Venture_Scale_Narrative.md`, `Pre_Seed_12M_Burn_Runway_CashFlow_PROMPT.md`, [`Pre_Seed_2M_SAR_Financial_Model_Blueprint.md`](Pre_Seed_2M_SAR_Financial_Model_Blueprint.md) — the canonical 2,000,000 SAR pre-seed ask & use-of-funds (10% equity, 12-month zero-revenue), [`Reven_Fundraising_Valuation_CorpFin_Analysis.md`](Reven_Fundraising_Valuation_CorpFin_Analysis.md) — pre-seed → seed → Series A financing, valuation & cap-table analysis (canonical pre-seed facts + labeled forward-looking assumptions) |
