...
| **Brand & design system** | [`brand/`](brand/) — the **source of truth for the Reven brand**: master guidelines PDF, full transcription ([`brand/BRAND_GUIDELINES.md`](brand/BRAND_GUIDELINES.md)), and machine-readable design tokens ([`brand/tokens/`](brand/tokens/)) for color, typography, layout and components |
