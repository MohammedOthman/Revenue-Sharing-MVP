...
| **Cost architecture (zero-based)** | [`Zero_Based_Cost_Architecture.md`](Zero_Based_Cost_Architecture.md) — the cost operating system (method, taxonomy, driver tree, decision packages, governance); [`Zero_Based_Cost_Input_Sheet.md`](Zero_Based_Cost_Input_Sheet.md) — fill-in inputs & decision-package catalog; `Zero_Based_Cost_Model.xlsx` — the driver-based cost engine (edit levers → cost-to-serve and gross margin vs the ≥70% floor, reconciled to the 2M SAR base) |
