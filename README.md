...
| **Pitch decks** | `Reven_Pitch_Deck.pdf` (June 2026) · [`Reven_Investor_Deck_2026.pptx`](Reven_Investor_Deck_2026.pptx) — an independently researched pre-seed deck on Sequoia's live ten-section structure sequenced on Raskin's five narrative beats, with [`Reven_Pitch_Deck_Strategic_Narrative.md`](Reven_Pitch_Deck_Strategic_Narrative.md) as its method, slide script and assumption register, and [`deck/`](deck/) as its generator |
