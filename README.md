...
| **Pricing & commercial** | `Reven_Pricing_Tiers_and_Rate_Card.md` (**operative rate card** — tiers, floors, governance, validation gates), `Reven_Pricing_v2_Red_Team_and_Proposals.md` (skeptic's review of the rate card + v2 proposals P1–P10), `Partner_Revenue_OS_Pricing_and_Commercial_Strategy.md`, `Partner_Revenue_OS_Pricing_Strategy_Red_Team.md`, `Reven_Pricing_Architecture_Deep_Research.md` |
